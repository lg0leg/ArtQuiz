...
function setQuizresult(quizType, quizResultArr) {
    let i;
    if (quizType =='artist') {i = 0} else {i = 1};
...
function setFilterForPassed(quizType, quizResultArr) {
    let i;
    if (quizType =='artist') {i = 0} else {i = 1};
    if (quizResultArr[i].portrait > 0) {document.querySelector('#portrait').classList.add('img-black-filter')};
    if (quizResultArr[i].landscape > 0) {document.querySelector('#landscape').classList.add('img-black-filter')};
    if (quizResultArr[i].stillLife > 0) {document.querySelector('#stillLife').classList.add('img-black-filter')};
    if (quizResultArr[i].impressionism > 0) {document.querySelector('#impressionism').classList.add('img-black-filter')};
    if (quizResultArr[i].expressionism > 0) {document.querySelector('#expressionism').classList.add('img-black-filter')};
    if (quizResultArr[i].avantgarde > 0) {document.querySelector('#avantgarde').classList.add('img-black-filter')};
    if (quizResultArr[i].renaissance > 0) {document.querySelector('#renaissance').classList.add('img-black-filter')};
    if (quizResultArr[i].surrealism > 0) {document.querySelector('#surrealism').classList.add('img-black-filter')};
    if (quizResultArr[i].kitsch > 0) {document.querySelector('#kitsch').classList.add('img-black-filter')};
    if (quizResultArr[i].minimalism > 0) {document.querySelector('#minimalism').classList.add('img-black-filter')};
    if (quizResultArr[i].interior > 0) {document.querySelector('#interior').classList.add('img-black-filter')};
    if (quizResultArr[i].nude > 0) {document.querySelector('#nude').classList.add('img-black-filter')};
}
